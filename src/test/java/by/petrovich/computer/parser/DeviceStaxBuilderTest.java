...
public class DeviceStaxBuilderTest extends TestCase {
    private String filePath = "src/test/resources/files/computers.xml";

    @Test
    public void testDevicesBuilder() throws DeviceException {
        DeviceStaxBuilder deviceStaxBuilder = new DeviceStaxBuilder();
        deviceStaxBuilder.devicesBuilder(filePath);
        List<DeviceAbstract> actual = deviceStaxBuilder.getDevices();
