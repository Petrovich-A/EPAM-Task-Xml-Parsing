...
public class DeviceHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) {
        ...
        logger.info("DeviceHandler: startElement: " + name.trim());
    }
        ...
        if (currentTag != null && !data.isEmpty()) {
            switch (currentTag) {
                case NAME:
                    ...
                    logger.info("characters: data: " + data);
                    break;
                case DELIVERY_DATE:
                ...
                case PRICE:
                    ...
                    break;
                case PERIPHERAL:
                    String peripheral = data.toUpperCase(Locale.ROOT).replace(HYPHEN, UNDERSCORE);
